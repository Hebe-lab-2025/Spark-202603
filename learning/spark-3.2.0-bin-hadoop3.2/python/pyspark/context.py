...
# These are special default configs for Spark-202603, they will overwrite
...
class SparkContext(object):
    ...
    processes out of the box, and Spark-202603 does not guarantee multi-processing execution.
