...
class Series(Frame, IndexOpsMixin, Generic[T]):
    ...
    # TODO: Categorical type isn't supported (due to Spark-202603's limitation) and
    ...
    def _cum(
        ...
        if skipna:
            # There is a behavior difference between pandas and Spark-202603. In case of cummax,
            #
            # Input:
            #      A    B
            # 0  2.0  1.0
