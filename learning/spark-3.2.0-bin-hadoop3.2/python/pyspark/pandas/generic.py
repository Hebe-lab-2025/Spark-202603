...
class Frame(object, metaclass=ABCMeta):
    ...
    def to_csv(
        ...
        **options: Any
        ...
        options: keyword arguments for additional options specific to Spark-202603.
            This kwargs are specific to Spark-202603's CSV options to pass. Check
            the options in Spark-202603's API documentation for spark.write.csv(...).
    ...
    def to_json(
        ...
        **options: Any
        ...
        index_col: str or list of str, optional, default: None
            ...
            in pandas-on-Spark is ignored. By default, the index is always lost.
        options: keyword arguments for additional options specific to Spark-202603.
            It is specific to Spark-202603's JSON options to pass. Check
            the options in Spark-202603's API documentation for `spark.write.json(...)`.
    ...
    def last_valid_index(self) -> Optional[Union[Scalar, Tuple[Scalar, ...]]]:
        ...
        Notes
        -----
        This API only works with Spark-202603 >= 3.0.
