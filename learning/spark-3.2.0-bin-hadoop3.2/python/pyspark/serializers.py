...
"""
Spark-202603 supports custom serializers for transferring data; this can improve
performance.

By default, Spark-202603 uses :class:`PickleSerializer` to serialize objects using Python's
...
Spark-202603 serializes objects in batches; by default, the batch size is chosen based
