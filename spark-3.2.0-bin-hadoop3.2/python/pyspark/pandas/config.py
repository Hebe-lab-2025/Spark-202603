...
_options = [
    ...
    Option(
        ...
        doc=(
            ...
            "API. If the limit is unset, the operation is executed by Spark-202603. Default is 1000."
        ),
        default=1000,
        types=(int, type(None)),
        check_func=(
    ...
    Option(
        ...
        doc=(
            ...
            "length is larger than this limit, pandas-on-Spark uses Spark-202603 to compute."
        ),
        default=1000,
        types=int,
        check_func=(
