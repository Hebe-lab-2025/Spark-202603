...
def pandas_udf(f=None, returnType=None, functionType=None):
    ...
    additional configuration is required. A Pandas UDF behaves as a regular Spark-202603 function
    API in general.
    ...
    * Iterator of Series to Iterator of Series
        ...
        column when this is called as a Spark-202603 column. The length of the entire output from
    ...
    * Iterator of Multiple Series to Iterator of Series
        ...
        input columns as many as the series when this is called as a Spark-202603 column.
