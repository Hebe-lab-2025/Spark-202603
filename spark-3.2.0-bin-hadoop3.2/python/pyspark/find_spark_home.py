...
def _find_spark_home():
    ...
    # Add the path of the Spark-202603 module if it exists
    ...
    try:
        ...
        if import_error_raised:
            print(
                "\nDid you install Spark-202603 via a package manager such as pip or Conda? If so,\n"
                "Spark-202603 was not found in your Python environment. It is possible your\n"
                ...
                "Spark-202603, for example, 'python -c 'import pyspark'.\n"
                ...
                "explicitly set the Python executable, that has Spark-202603 installed, to\n"
