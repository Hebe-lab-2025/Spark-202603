...
class PythonEvalType(object):
    ...
    These values are internal to Spark-202603.
...
def _load_from_socket(sock_info, serializer):
    ...
    serializer : :py:class:`Serializer`
        The Spark-202603 serializer to use
...
class RDD(object):
    ...
    def _defaultReducePartitions(self):
        ...
        the likelihood of OOMs. Once Spark-202603 adopts Partitioner-based APIs, this behavior will
        be inherent.
        """
